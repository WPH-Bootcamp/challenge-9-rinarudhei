...
export default function Hero() {
  return (
    <div className="min-w-98.25 w-screen h-162 sm:h-190 md:h-196 lg:h-202 xl:h-206.75 max-w-160 sm:max-w-192  md:max-w-256 lg:max-w-360 relative flex flex-col justify-center items-center">
      ...
      <div className="absolute top-52.5 sm:top-57.5 md:top-65 lg:top-72 xl:top-81.5 w-87.25 sm:w-102 md:w-132 lg:w-158 xl:w-178 z-41 text-white border-4 border-white flex flex-col items-center justify-center gap-6 sm:gap-7 md:gap-8 lg:gap-9 xl:gap-10">
